...
const options = [
    {
        ...
        subtitle: 'Hamesha deadlines ka rona.',
        gradient: 'from-blue-500/20 to-cyan-500/20',
    },
    {
        value: '9-to-5 Job',
        emoji: '💼',
        title: 'Corporate Slavery',
        subtitle: 'Boss se pareshan, need caffeine.',
        gradient: 'from-gray-500/20 to-slate-500/20',
    },
    {
        value: 'Artist/Founder',
        emoji: '🎨',
        title: 'Creative Hustle',
        subtitle: 'Raat bhar jagna, sapne dekhna.',
    ...
    },
    {
        ...
        emoji: '🍿',
        title: 'Just Chilling',
        subtitle: 'Netflix, Memes, Gossip. No stress.',
        gradient: 'from-green-500/20 to-emerald-500/20',
    },
];

export const StepLore = ({ selected, onSelect }: StepLoreProps) => {
            ...
            <div className="max-w-lg w-full">
                ...
                >
                    ...
                    <h2 className="font-display text-2xl md:text-3xl font-bold text-foreground">
                        ...
                        <br />
                        <span className="neon-text">Life mein kya chal raha hai?</span>
                    </h2>
                    <p className="text-muted-foreground text-sm mt-3">
                        Velle log boring hote hain. Inki life mein kya struggle chal raha hai?
                    </p>
                </motion.div>
