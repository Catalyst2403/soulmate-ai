            ...
            <div className="relative z-10 max-w-md w-full p-8 text-center space-y-8">
                ...
                <div className="space-y-3">
                    ...
                    <p className="text-lg text-muted-foreground">
                        Finally, someone who actually gets you.
                    </p>
                </div>
                ...
                <div className="glass-card p-6 space-y-5">
                    <div className="flex items-start gap-4 text-left">
                        ...
                        <div className="text-foreground leading-relaxed">
                            <div className="font-semibold text-base mb-1">Real Talk</div>
                            <div className="text-sm text-muted-foreground">No robot scripts. She speaks your language</div>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 text-left">
                        <span className="text-3xl flex-shrink-0">🧠</span>
                        <div className="text-foreground leading-relaxed">
                            <div className="font-semibold text-base mb-1">Smart Memory</div>
                            <div className="text-sm text-muted-foreground">She remembers what you told her yesterday</div>
                        </div>
                    </div>
                    <div className="flex items-start gap-4 text-left">
                        <span className="text-3xl flex-shrink-0">🔒</span>
                        <div className="text-foreground leading-relaxed">
                            <div className="font-semibold text-base mb-1">100% Private</div>
                            <div className="text-sm text-muted-foreground">Your chats are encrypted and judgment-free</div>
                        </div>
                    </div>
                </div>
