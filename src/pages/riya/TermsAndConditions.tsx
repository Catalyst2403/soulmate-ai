                    ...
                    <div className="prose prose-invert max-w-none space-y-4 text-foreground/90">
                        ...
                        <ul className="list-disc pl-6 space-y-3">
                            ...
                            <li className="text-neon-cyan font-semibold">
                                AI Service and Persona Disclosure: "Riya Singh" as depicted on Instagram and within
                                our platform is a purely fictional AI persona created using generative artificial
                                intelligence. Riya Singh does not exist in real life. All interactions, statements,
                                feelings, and narratives expressed by Riya Singh are algorithmically generated and
                                must be considered fictional for entertainment purposes only.
                            </li>
                            <li className="text-neon-cyan">
                                Limitation of Liability for AI Content: You acknowledge that AI output is generated
                                by third-party systems and may be unpredictable. Miten Solanki and Catalyst Vibe
                                shall not be held liable for any content generated by the AI, including but not
                                limited to statements that may be perceived as offensive, inaccurate, or
                                defamatory. Reliance on any information provided by the AI is strictly at your own
                                risk. The output should not be treated as factual information or professional advice.
                            </li>
                        </ul>
                    </div>
